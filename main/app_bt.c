...
static void hci_cmd_send_ble_set_adv_data(void)
{
    ...
    adv_data[12] = 0x20;  // Beacons TX power at 0m goo.gl/rxusqM
    ...
    adv_data[21] = 0x72;  // URL add  8 'r'
    adv_data[22] = 0x78;  // URL add  9 'x'
    adv_data[23] = 0x75;  // URL add 10 'u'
    adv_data[24] = 0x73;  // URL add 11 's'
    adv_data[25] = 0x71;  // URL add 12 'q'
    adv_data[26] = 0x4D;  // URL add 13 'M'
